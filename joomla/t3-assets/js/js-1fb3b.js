...
/*===============================
/templates/uber/acm/tabs/js/script.js
================================================================================*/;
jQuery(window).load(function(){if(jQuery('.acm-tabs .style-2 .tab-content .active').length>1){jQuery('.acm-tabs .style-2 .tab-content .active').last().removeClass('active');}});
