	...
	<div class="acm-features style-2 <?php echo $helper->get('features-style'); ?>">
		<div class="container">
			...
			?>
				...
				<div class="features-item col-xs-6 col-sm-<?php echo 12/$column ?> center">
					

					<?php if ($helper->get('data.title-link', $i)): ?>
					<a href="<?php echo $helper->get('data.title-link',$i); ?>"  target="_blank" title="<?php echo $helper->get('data.title', $i) ?>">
					<?php endif; ?>
