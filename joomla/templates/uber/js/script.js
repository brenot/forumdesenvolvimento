...
(function($){
	...
	$(document).ready(function(){
		...
		if (formContact.length > 0) {
			...
			$('#jform_contact_name', formContact).attr('placeholder','Nome');

			$('#jform_contact_email', formContact).attr('placeholder','Email');

			$('#jform_contact_emailmsg', formContact).attr('placeholder','Assunto');

			$('#jform_contact_message', formContact).attr('placeholder','Escreva aqui a sua mensagem...');
