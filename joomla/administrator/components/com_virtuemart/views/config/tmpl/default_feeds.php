...
<fieldset>
	...
	<tr>
	    <td class="key">
		<span class="hasTip" title="<?php echo vmText::_('COM_VIRTUEMART_ADMIN_CFG_FEED_CACHE_TIP'); ?>">
		<?php echo vmText::_('COM_VIRTUEMART_ADMIN_CFG_FEED_CACHE') ?>
		</span>
	    </td>
	    <td>
		...
		<?php echo vmText::_('COM_VIRTUEMART_ADMIN_CFG_FEED_CACHETIME') ?>
	    </td>
	</tr>

	<tr>
	    <td class="key">
		<span class="hasTip" title="<?php echo vmText::_('COM_VIRTUEMART_ADMIN_CFG_FEED_TITLE_CATEGORIES_TIP'); ?>">
		<?php echo vmText::_('COM_VIRTUEMART_ADMIN_CFG_FEED_TITLE') ?>
		</span>
		</td>
	    <td>
	...
	<tr>
	    <td class="key">
		<span class="hasTip" title="<?php echo vmText::_('COM_VIRTUEMART_ADMIN_CFG_FEED_TITLE_CATEGORIES_TIP'); ?>">
		<?php echo vmText::_('COM_VIRTUEMART_ADMIN_CFG_FEED_TITLE_CATEGORIES') ?>
		</span>
	    </td>
	    <td>
	...
	<tr>
		...
		<?php echo vmText::_('COM_VIRTUEMART_ADMIN_CFG_FEED_LIMITTEXT') ?>
		</span>
	    </td>
	    <td>
