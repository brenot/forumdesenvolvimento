		...
		<div class="onelineblockoptions">
			<div class="acyblocktitle"><?php echo JText::_('ACY_FILE').' : '.$this->escape($this->file->name); ?>
				<?php if(!empty($this->showLatest)){ ?>
					<button type="button" class="acymailing_button" onclick="javascript:submitbutton('latest')" style="margin-left: 15px !important;"> <?php echo JText::_('LOAD_LATEST_LANGUAGE'); ?> <i class="acyicon-import" style="margin-left: 10px;"></i></button> <?php } ?>
			</div>
