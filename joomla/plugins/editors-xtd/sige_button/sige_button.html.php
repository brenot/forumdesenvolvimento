	...
	<?php if($method != 2) : ?>
		...
		<div id="thumbnail">
			<table width="100%" style="border-spacing:10px">
				<tbody>
				<tr>
					<td width="20%"><label id="paramsthumbs-lbl" for="paramsthumbs" class="tooltip"
					                       title="thumbs :: <?php echo $thumbsdesc; ?>">thumbs</label></td>
					<td>
				...
				<tr>
					<td width="20%"><label id="paramsthumbdetail-lbl" for="paramsthumbdetail" class="tooltip"
					                       title="thumbdetail :: <?php echo $thumbnaildetaildesc; ?>">thumbdetail</label>
					</td>
					<td>
				...
				<tr>
					<td width="20%"><label id="paramscalcmaxthumbsize-lbl" for="paramscalcmaxthumbsize"
					                       class="tooltip"
					                       title="calcmaxthumbsize :: <?php echo $calcmaxthumbsizedesc; ?>">calcmaxthumbsize</label>
					</td>
					<td>
				...
				<tr>
					<td width="20%"><label id="paramsratio-lbl" for="paramsratio" class="tooltip"
					                       title="ratio :: <?php echo $ratiodesc; ?>">ratio</label></td>
					<td>
				...
				<tr>
					<td width="20%"><label id="paramscrop-lbl" for="paramscrop" class="tooltip"
					                       title="crop :: <?php echo $cropdesc; ?>">crop</label></td>
					<td>
				...
				<tr>
					<td width="20%"><label id="paramscrop_factor-lbl" for="paramscrop_factor" class="tooltip"
					                       title="crop_factor :: <?php echo $cropfactordesc; ?>">crop_factor</label>
					</td>
					<td><input name="paramscrop_factor" id="paramscrop_factor" value="" type="text"/></td>
				</tr>
				<tr>
					<td width="20%"><label id="paramswatermark-lbl" for="paramswatermark" class="tooltip"
					                       title="watermark :: <?php echo $watermarkdesc; ?>">watermark</label></td>
					<td>
				...
				<tr>
					<td width="20%"><label id="paramswatermarkposition-lbl" for="paramswatermarkposition"
					                       class="tooltip"
					                       title="watermarkposition :: <?php echo $watermarkpositiondesc; ?>">watermarkposition</label>
					</td>
					<td>
				...
				<tr>
					<td width="20%"><label id="paramswatermarkimage-lbl" for="paramswatermarkimage" class="tooltip"
					                       title="watermarkimage :: <?php echo $watermarkimagedesc; ?>">watermarkimage</label>
					</td>
					<td><input name="paramswatermarkimage" id="paramswatermarkimage" value="" type="text"/></td>
				</tr>
				<tr>
					<td width="20%"><label id="paramsencrypt-lbl" for="paramsencrypt" class="tooltip"
					                       title="encrypt :: <?php echo $encryptdesc; ?>">encrypt</label></td>
					<td>
