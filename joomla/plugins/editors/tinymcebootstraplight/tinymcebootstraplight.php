 ...
 * @since  1.5
 */
class PlgEditorTinymcebootstraplight extends JPlugin
{
    /**
    ...
    public function onInit()
    {
        ...
        /* tinyMce Bootstrap plugin params */

        $bootstrap_plugin_light_config = '';
        $bootstrap_plugin_light = $this->params->get('bootstraplight', '');
        if ($bootstrap_plugin_light) {
            $bootstrap_elements = [];
            $elements_list = array('btn', 'icon', 'image', 'table', 'template', 'breadcrumb', 'pager', 'label', 'badge', 'alert', 'panel', 'snippet');
            $disabled_elements_list = array('icon', 'image', 'table', 'template', 'breadcrumb', 'pager', 'panel');
            foreach ($elements_list as $e) {
                if (in_array($e, $disabled_elements_list)) {
                    $$e = "true";
                } else {
                    $e_value = $this->params->get($e, '');
                    if ($e_value) {
                        $$e = "true";
                    } else {
                        $$e = "false";
            ...
            $bootstrap_plugin_light_config = "bootstrapLightConfig: {
                    ...
                    'allowSnippetManagement': $snippetManagement,
        ...
        $plugins        = array(
            ...
            'importcss');
        if ($bootstrap_plugin_light) {
            $plugins[] = 'bootstraplight';
            $toolbar1_add[] = 'bootstraplight';
        }
        $toolbar1_add[] = 'bold';
        $toolbar1_add[] = 'italic';
        ...
        switch ($mode) {
            case 0: /* Simple mode*/
                ...
                $plugins = '';
                if ($bootstrap_plugin_light) {
                    $toolbar1 = "bootstraplight | " . $toolbar1;
                    $plugins = "bootstraplight";
                }
                $return = $load .
            ...
            default: /* Advanced mode*/
                ...
                if ($bootstrap_plugin_light) {
                    $toolbar1 = "bootstraplight | " . $toolbar1;
                    $plugins = "bootstraplight " . $plugins;
                }
