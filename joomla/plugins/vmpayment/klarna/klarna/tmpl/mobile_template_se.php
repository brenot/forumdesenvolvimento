...
<center><p> -- OR --</p></center>
         ...
         <!--
             ...
             placeHolderText['mobile_code'] = '<?php echo vmText::_('VMPAYMENT_KLARNA_MOBILE_MOBILE_CODE'); ?>';
         ...
         <div class="klarnaMobile_box">
             ...
             <div class="klarnaMobile_info">
                 <?php echo vmText::_('VMPAYMENT_KLARNA_MOBILE_TOPINFO'); ?> <a href="#top"><?php echo vmText::_('VMPAYMENT_KLARNA_MOBILE_AGREEMENT'); ?></a>
             </div>
             <div class="klarnaMobile_boxContent">
                 <h1>1. <?php echo vmText::_('VMPAYMENT_KLARNA_MOBILE_MOBILEPHONENO'); ?></h1>
                 ...
                 <h1>2. <?php echo vmText::_('VMPAYMENT_KLARNA_MOBILE_PINCODE'); ?></h1>
                 <div class="klarnaMobile_boxInputField">
                     <div class="klarnaMobile_boxInputField_left_inputPlaceholder">
             ...
             <div class="klarnaMobile_error_Inner">
                 <h3><?php echo vmText::_('VMPAYMENT_KLARNA_MOBILE_WHOOPS'); ?></h3>
                 <div class="klarnaMobile_errorText"  id="klarnaMobile_errorText">

                 </div>
                 <div class="klarnaMobile_errorClose">
                     <?php echo vmText::_('VMPAYMENT_KLARNA_MOBILE_CLOSE'); ?>
                 </div>
             </div>
         </div>